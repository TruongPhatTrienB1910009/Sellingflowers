import { AutoTokenizer, AutoProcessor, AutoModel, RawImage, Processor, PreTrainedModel, PreTrainedTokenizer, AutoConfig, PretrainedConfig } from "@xenova/transformers";
...
class Embedder {
  ...
  private config!: PretrainedConfig;

  async init(modelName: string) {
    // Load the model, tokenizer and processor
    this.config = await AutoConfig.from_pretrained(modelName);
